...
def agregar_vivienda(viviendas: list, nombre: str, direccion: str):
    if not buscar_vivienda_por_nombre(nombre, viviendas):
        viviendas.append({
            "nombre": nombre,
            "direccion": direccion,
            "ambientes": []  
...
def buscar_vivienda_por_nombre(nombre: str, viviendas: list):
...
def eliminar_vivienda(nombre: str, confirmar: str, viviendas: list):
    vivienda_a_eliminar = buscar_vivienda_por_nombre(nombre, viviendas)
...
def listar_viviendas(viviendas: list):
    if not viviendas:
    ...
    viviendas = [
        {
            ...
            "dispositivos": ["Comedor", "Baño"]
        },
        {
            "nombre": "Casa de Verano",
            "direccion": "Calle del Sol 789",
            "dispositivos": ["Dormitorio", "Cocina"]
        },
        {
